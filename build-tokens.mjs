...
const components = {
  ...
  Segmented: {
    ...
    itemColor:             C["text-sub-color-transparent"],
    itemHoverColor:        C["component-primary"],
    itemActiveColor:       C["component-active"],
    itemSelectedColor:     C["component-primary"],
    itemDisabledColor:     C["text-color-transparent-disable"],
    itemDisabledHoverColor:C["text-color-transparent-disable-hover"],
    ...
    badgeText:             C["text-sub-color-transparent"],
    badgeActiveBg:         C["component-light-background"],
    badgeActiveText:       C["component-primary"],
    badgeDisabledText:     C["text-color-transparent-disable"],
    badgeDisabledHoverText:C["text-color-transparent-disable-hover"],
