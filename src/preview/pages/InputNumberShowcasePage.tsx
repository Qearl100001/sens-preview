...
import inputNumberDevDoc from "../../design-system/components/base/inputnumber.md?raw";
import { InputNumberStatesPreview, SensInputNumber } from "../../ui/SensInputNumber";
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: "100%" }}>
      ...
      <SensInputNumber
        ...
        defaultValue={isReadOnly && warningPlacement ? 100 : undefined}
      />
      <Text type="secondary">
        默认宽 188px；步进器 hover 才露出（handleVisible: auto）；悬停看箭头变绿
      </Text>
    </Space>
  );
}
...
export default function InputNumberShowcasePage() {
  return (
    <ComponentShowcaseLayout
      ...
      matrix={<InputNumberStatesPreview />}
      designDocSource={inputDesignDoc}
      devDocSource={inputNumberDevDoc}
    />
  );
}
